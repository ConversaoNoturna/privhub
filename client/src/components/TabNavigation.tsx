        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex-1 py-3 sm:py-4 px-2 sm:px-4 flex items-center justify-center gap-1 sm:gap-2 font-medium transition-all duration-300 relative group text-sm sm:text-base',
                isActive
                  ? 'text-primary'
